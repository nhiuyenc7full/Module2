...
namespace BoDeTracNghiemDemo.Controllers
{
    public class NguoiDungsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ten,Email,MatKhau,DiaChi")] NguoiDung nguoiDung)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ten,Email,MatKhau,DiaChi")] NguoiDung nguoiDung)
        {
            if (id != nguoiDung.Id)
            {
                return NotFound();
